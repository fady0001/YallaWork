...
class AppColor {
  static Color primaryColor = const Color(0xffff962d);
  ...
  static MaterialColor primarySwatch = const MaterialColor(
    ...
    {
      50: Color(0xfffdf5d7),
      100: Color(0xffe5d5a8),
      200: Color(0xffedd4a0),
      300: Color(0xfff6db81),
      400: Color(0xffefd198),
      500: Color(0xffefc456),
      600: Color(0xffe8bc79),
      700: Color(0xffdfa752),
      800: Color(0xffeca438),
      900: Color(0xFFFF961D),
    },
  );
}
